...
const Map = ({ coords, setCoords, bounds, setBounds, toggleMap, recAreas, darkMode, childClicked, setChildClicked, activeUser, setChildHover }) => {
    ...
    return (
        <div className="h-full w-full">
            <GoogleMapReact
                ...
                onChildMouseLeave={(child) => setChildHover()}
            >
