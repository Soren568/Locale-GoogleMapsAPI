...
export const loginAsGuest = (e, user) => {
    e.preventDefault();
...
const LoginForm = () => {
    ...
    const frontEndValidation = e => {
        ...
        if (e.target.name === "email") {
            ...
            emailRE.test(e.target.value) ? setEmailVal(false) : setEmailVal(true)
                        ...
                        <form onSubmit={e => handleLogin(e, { email, password })}>
                            ...
                            <div className='w-full flex-col'>
                                <div className="w-full mb-2">
                                    <button className="block w-full mx-auto bg-green-500 hover:bg-green-700 focus:bg-green-700 text-white rounded-lg px-3 py-3 font-semibold">LOGIN</button>
                                </div>
                                <div className="flex w-full justify-between">
                                    <Link to="/register" className="bg-cyan-400 hover:bg-cyan-500 focus:bg-cyan-500 text-white rounded-lg px-2 py-1 text-xs text-center self-center">Not a user yet?</Link>
